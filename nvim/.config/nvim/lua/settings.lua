...
vim.opt.smartcase      = true         -- Do not ignore case with captials
...
vim.opt.autoindent     = true         -- Round indent ?
vim.opt.cindent        = true         -- Strincter indenting rules for C programs
vim.opt.shiftround     = true         -- Round indent ?
vim.opt.shiftwidth     = 2            -- Set indenting to 2 spaces
